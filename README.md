...
With the exception of very small tasks, code is written so others can read it. With great power comes greater responsibility. The fact you *can* do something in Bash doesn't necessarily mean you should! ;)
