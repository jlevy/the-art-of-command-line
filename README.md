...
- Use `screen` or [`tmux`](https://tmux.github.io/) to multiplex the screen, especially useful on remote ssh sessions and to detach and re-attach to a session. `byobu` can enhance screen or tmux by providing more information and easier management. A more minimal alternative is [`abduco`](https://github.com/martanne/abduco), [`dvtm`](https://github.com/martanne/dvtm), [`dtach`](https://github.com/bogner/dtach).
