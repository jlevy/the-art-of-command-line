...
اعرف عمل كل من: <code>less</code> ،  <code>head</code> ،  <code>tail</code> ، و <code>tail +F</code>
(وان امكن <code>ln</code> و <code>ln -s</code>)
كذلك كن ملما باختلافات وفوائد كل من الروابط "الرقيقة" والروابط "الصلبة"،  <code>chown</code> ،  <code>chmod</code> ، <code>du</code>  للحصول على نبذة مختصرة عن القرص الصلب:  <code>du -sh *</code> .
