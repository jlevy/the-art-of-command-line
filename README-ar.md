...
- [المقدمة](#meta)
- [الأوليات](#basics)
- [الأستخدامات اليومية](#everyday-use)
- [معالجة الملفات والمعلومات](#processing-files-and-data)
- [تصحيح النظام](#system-debugging)
- [أوامر السطر الواحد](#one-liners)
- [أومر غامضة ولكن مهمة](#obscure-but-useful)
- [OS X أوامر خاصة بنظام](#os-x-only)
- [مصادر اضافية](#more-resources)
...
اتقان اوامر نظام لنكس هي احدى المهارات التي لا تحظى بالأهتمام الذي تستحقة. يراها الكثر على انها شيء مبهم. ولكنها في حقيقة الامر ليست كذلك. وجدت هذة الاوامر والايعازات لتساعدك كمستخدم\مستخدمة على اتمام اعمالك بسرعة واتقان.
نقدم لك هنا بعض النصائح والارشادات في كيفية استخدام اوامر وايعازات نظام لنكس التي وجدناها مفيدة. بعض هذة الارشادات بدائية, والبعض الاخر متقدم وعلى درجة من التعقيد. هذة الصفحة ليست بالطويلة او الشاملة, ولكنك اذا تمكنت من اتقان الاوامر المذكروة هنا, فستكون\تكونين قد تعلمت الكثير.
...
- هذا الدليل هو للمبتدئين وذوي الخبرة. اهدافة تشتمل على **الدقة**: عن طريق التركيز على المسائل والحالات الاكثر شيوعاً. و**الإيجاز**: بتفادي الامور الثانوية، او تلك التي تؤدي بقارها الى الخروج عن سياق الموضوع. كل ايعاز تجده هنا هو اما اساسي للتعامل مع النظام في بعض الحالات، او انه (في حالات معينة) يوفر عليك الكثير من الوقت بالمقارنة مع البدائل.
