...
(وان امكنcode>tail +F</code> > )
كذلك كن ملما باختلافات وفوائد كل من الروابط "الرقيقة" والروابط "الصلبة"(<
<code>ln</code و <code>ln -s</code>). 
<code>chown</code> ،  <code>chmod</code> ادوات تغيير صاحب ورخص الملفات: 
