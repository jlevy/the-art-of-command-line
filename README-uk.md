...
- Для більш серйозного дебаггінга мережі використовуйте `tcpdump`, `wireshark`, `tshark`, і `ngrep`.
...
- `tcpdump`, `wireshark` і `tshark`: перехоплення пакетів і дебагінг мережі
