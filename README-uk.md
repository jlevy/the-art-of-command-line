...
Ця результат роботи [багатьох авторів і перекладачів](AUTHORS.md).
...
- Щоб все вміщалось на одній сторінці, вся інформація вставлена прямо тут. У  вас вистачить  вмінь, щоб самостійно вивчити питання більш детально в інших джерел. Використовуйте `apt-get`, `yum`, `dnf`, `pacman`, `pip` та `brew` (залежно від вашої системи управління пакетами) для установки нових програм.
