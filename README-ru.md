...
- `expr`: для выполнения арифметических и булевых операций, а также вычисления регулярных выражений
...
- `printenv`: печать переменных окружения (полезно в скриптах или дебаггинге)

- `look`: найти английские слова (или строки) в файле

- `cut `, `paste` и `join`: манипуляции с данными

- `fmt`: форматироввание параграфов в тексте
